...
export async function GET(req: Request) {
  ...
  try {
    ...
    webhookUrl = await resolveWebhookUrl('siatWebhookUrl', 'SIAT_WEBHOOK_URL', SIAT_DEFAULT)
    ...
    console.error('[siat] handler error', webhookUrl, error)
